...
mod __parse__Prog {
        ...
        loop {
            ...
            match __nt {
                ...
                __Nonterminal::St_2b(__nt) => {
                    let __sym0 = &mut Some(__nt);
                    __result = try!(__state17(input, __tokens, __lookahead, __sym0));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym0 = &mut Some(__nt);
                    __result = try!(__state18(input, __tokens, __lookahead, __sym0));
                }
                _ => {
                    return Ok((__lookahead, __nt));
                }
    ...
    >(
        ...
        __tokens: &mut __TOKENS,
        __lookahead: Option<(usize, (usize, &'input str), usize)>,
        __sym0: &mut Option<(usize, Program, usize)>,
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        let mut __result: (Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>);
        match __lookahead {
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (17, __tok0), __loc2)) => {
                let mut __sym2 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state72(input, __tokens, __sym0, __sym1, __sym2));
            }
            Some((__loc1, (18, __tok0), __loc2)) => {
                let mut __sym2 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state23(input, __tokens, __sym2));
        ...
        while __sym1.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym2 = &mut Some(__nt);
                    __result = try!(__state71(input, __tokens, __lookahead, __sym1, __sym2));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym2 = &mut Some(__nt);
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (0, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state29(input, __tokens, __sym2, __sym3));
            }
            Some((__loc1, (10, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (10, __tok0), __loc2)) => {
                let mut __sym1 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state81(input, __tokens, __sym0, __sym1));
            }
            Some((_, (1, _), _)) |
            Some((_, (3, _), _)) |
            Some((_, (16, _), _)) => {
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (7, __tok0), __loc2)) => {
                let mut __sym1 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state83(input, __tokens, __sym0, __sym1));
            }
            Some((_, (0, _), _)) |
            Some((_, (1, _), _)) |
            Some((_, (3, _), _)) |
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (3, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state84(input, __tokens, __sym0, __sym1, __sym2, __sym3));
            }
            Some((__loc1, (16, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state85(input, __tokens, __sym2, __sym3));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (19, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state24(input, __tokens, __sym3));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
        ...
        while __sym2.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::AssE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state86(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3));
                }
                __Nonterminal::EqE(__nt) => {
                    let __sym3 = &mut Some(__nt);
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (9, __tok0), __loc2)) => {
                let mut __sym2 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state88(input, __tokens, __sym0, __sym1, __sym2));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym1.is_some() {
            ...
            match __nt {
                __Nonterminal::Num(__nt) => {
                    let __sym2 = &mut Some(__nt);
                    __result = try!(__state95(input, __tokens, __lookahead, __sym0, __sym1, __sym2));
                }
                _ => {
                    return Ok((__lookahead, __nt));
                }
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym1.is_some() {
            ...
            match __nt {
                __Nonterminal::Num(__nt) => {
                    let __sym2 = &mut Some(__nt);
                    __result = try!(__state96(input, __tokens, __lookahead, __sym0, __sym1, __sym2));
                }
                _ => {
                    return Ok((__lookahead, __nt));
                }
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (13, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state107(input, __tokens, __sym4));
            }
            Some((__loc1, (14, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
            ...
            Some((__loc1, (19, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state24(input, __tokens, __sym4));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
        ...
        while __sym3.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state104(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state105(input, __tokens, __lookahead, __sym4));
                }
                _ => {
                    return Ok((__lookahead, __nt));
                }
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (8, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state111(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (3, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state112(input, __tokens, __sym0, __sym1, __sym2, __sym3));
            }
            Some((__loc1, (16, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state85(input, __tokens, __sym2, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym2.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::AssE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state113(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3));
                }
                __Nonterminal::EqE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state6(input, __tokens, __lookahead, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (7, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state83(input, __tokens, __sym2, __sym3));
            }
            Some((_, (0, _), _)) |
            Some((_, (1, _), _)) |
            Some((_, (3, _), _)) |
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (10, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state81(input, __tokens, __sym2, __sym3));
            }
            Some((_, (1, _), _)) |
            Some((_, (3, _), _)) |
            Some((_, (16, _), _)) => {
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (11, __tok0), __loc2)) => {
                ...
                __result = try!(__state115(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state116(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym3.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state121(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state105(input, __tokens, __lookahead, __sym4));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (8, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state122(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            ...
            Some((__loc1, (13, __tok0), __loc2)) => {
                let mut __sym6 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state133(input, __tokens, __sym6));
            }
            Some((__loc1, (14, __tok0), __loc2)) => {
                let mut __sym6 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state134(input, __tokens, __sym6));
            }
            Some((__loc1, (15, __tok0), __loc2)) => {
                let mut __sym6 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state135(input, __tokens, __sym6));
            }
            Some((__loc1, (18, __tok0), __loc2)) => {
                let mut __sym6 = &mut Some((__loc1, (__tok0), __loc2));
            ...
            Some((__loc1, (19, __tok0), __loc2)) => {
                let mut __sym6 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state24(input, __tokens, __sym6));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
        ...
        while __sym5.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::IfSt(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state127(input, __tokens, __lookahead, __sym6));
                }
                __Nonterminal::IfThen(__nt) => {
                    let __sym6 = &mut Some(__nt);
                ...
                __Nonterminal::IfThenElse(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state129(input, __tokens, __lookahead, __sym6));
                }
                __Nonterminal::MultE(__nt) => {
                    let __sym6 = &mut Some(__nt);
                ...
                __Nonterminal::St(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state130(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym6 = &mut Some(__nt);
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (11, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state139(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state140(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (12, __tok0), __loc2)) => {
                ...
                __result = try!(__state142(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6, __sym7));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (3, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state147(input, __tokens, __sym0, __sym1, __sym2, __sym3));
            }
            Some((__loc1, (16, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state85(input, __tokens, __sym2, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym2.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::AssE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state148(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3));
                }
                __Nonterminal::EqE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state6(input, __tokens, __lookahead, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym5.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state149(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state131(input, __tokens, __lookahead, __sym6));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym1.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::OrE(__nt) => {
                    let __sym2 = &mut Some(__nt);
                    __result = try!(__state150(input, __tokens, __lookahead, __sym0, __sym1, __sym2));
                }
                _ => {
                    return Ok((__lookahead, __nt));
                }
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym3.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state153(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state105(input, __tokens, __lookahead, __sym4));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (8, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state154(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym7 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state155(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6, __sym7));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (3, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state156(input, __tokens, __sym0, __sym1, __sym2, __sym3));
            }
            Some((__loc1, (16, __tok0), __loc2)) => {
                let mut __sym3 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state85(input, __tokens, __sym2, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym2.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::AssE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state157(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3));
                }
                __Nonterminal::EqE(__nt) => {
                    let __sym3 = &mut Some(__nt);
                    __result = try!(__state6(input, __tokens, __lookahead, __sym3));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (11, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state158(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym3.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state160(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym4 = &mut Some(__nt);
                    __result = try!(__state105(input, __tokens, __lookahead, __sym4));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (8, __tok0), __loc2)) => {
                let mut __sym4 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state161(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym5.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state162(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state131(input, __tokens, __lookahead, __sym6));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (11, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state163(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym5 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state164(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym7 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state165(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6, __sym7));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        while __sym5.is_some() {
            ...
            match __nt {
                ...
                __Nonterminal::St(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state166(input, __tokens, __lookahead, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6));
                }
                __Nonterminal::VarDeclSt(__nt) => {
                    let __sym6 = &mut Some(__nt);
                    __result = try!(__state131(input, __tokens, __lookahead, __sym6));
    ...
    ) -> Result<(Option<(usize, (usize, &'input str), usize)>, __Nonterminal<>), __ParseError<usize,(usize, &'input str),()>>
    {
        ...
        match __lookahead {
            Some((__loc1, (12, __tok0), __loc2)) => {
                let mut __sym7 = &mut Some((__loc1, (__tok0), __loc2));
                __result = try!(__state167(input, __tokens, __sym0, __sym1, __sym2, __sym3, __sym4, __sym5, __sym6, __sym7));
            }
            _ => {
                return Err(__ParseError::UnrecognizedToken {
                    token: __lookahead,
